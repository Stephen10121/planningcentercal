<script lang="ts">
    ...
    import RenderInSpecificPath from "$lib/RenderInSpecificPath.svelte";
...
<RenderInSpecificPath pathname={data.pathname} dissalowedPaths={["/", "/calendar/*"]}>
